...
import { ArrowLeft, Save, User, Clock, FileText, Globe, Eye } from 'lucide-react';
...
const BLOG_CATEGORIES = ['GOOGLE', 'CLOUD ENGINEERING', 'SOFTWARE DEVELOPMENT', 'E-COMMERCE', 'GENERAL'];
