...
export default function ProjectForm({ initialData, isEditing = false }: ProjectFormProps) {
  ...
  const defaultValues: ProjectFormValues = {
    ...
    deliverables: initialData?.deliverables || ['Web Design', 'Web Development'],
    process: initialData?.process || ['We partnered with the client to revitalize their digital presence...'],
