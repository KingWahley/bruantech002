      ...
      <div className="max-w-[95%] md:max-w-[90%] mx-auto w-full flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
          {bruantechBlogs.map((blog, index) => (
            <div key={index} className="flex flex-col border border-gray-200 rounded-2xl overflow-hidden hover:shadow-lg transition-shadow bg-white">
              ...
              <div className="p-8 flex flex-col grow">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-4 line-clamp-3">
                  {blog.title}
                </h3>
